...
class _DyscalculiaQuizState extends State<NumberBasedQuiz> {
  ...
  Widget build(BuildContext context) {
    final questionProvider = Provider.of<NumberBasedProvider>(context);
  ...
  Widget _buildTextQuestion(
    ...
    final questionProvider =
        Provider.of<NumberBasedProvider>(context, listen: false);
